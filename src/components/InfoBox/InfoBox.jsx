        ...
        <div className="swift-signup-main-info-content">
          <div className="swift-signup-main-info-1">
            <p>
              ...
              <b>Google Machine Learning Architecture</b> to assist your
            ...
            <p>
              Use of ETFs to express asset allocation views will also help
              negate the well recognised <b>Negative Manager Selection</b>{" "}
              Effect. (overall likely underperformance caused by use of active
              funds)
            </p>
            <p>
